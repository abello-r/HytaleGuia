...
export default function TrendingCard({ 
  ...
  return (
    <div 
      className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl hover:border-[#00d2ff]/50 hover:bg-white/10 transition-all duration-300 group cursor-pointer relative"
      onClick={handleClick}
    >
      {/* Kweebec */}
      {isLast && (
